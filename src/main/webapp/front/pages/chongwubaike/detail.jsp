				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>宠物类别：</span>
							<span class="desc">
								{{detail.chongwuleibie}}
							</span>
						</div>
																								<div class="detail-item">
							<span>饲养方式：</span>
							<span class="desc">
								{{detail.siyangfangshi}}
							</span>
						</div>
																								<div class="detail-item">
							<span>宠物简介：</span>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`chongwubaike`);
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
															vue.title = vue.detail.chongwumingcheng;
																																																																						// 轮播图片
					vue.swiperList = vue.detail.chongwutupian ? vue.detail.chongwutupian.split(",") : [];
																																			var swiperItemHtml = '';
