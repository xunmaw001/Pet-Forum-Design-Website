				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>饲料种类：</span>
							<span class="desc">
								{{detail.siliaozhonglei}}
							</span>
						</div>
																								<div class="detail-item">
							<span>品牌商家：</span>
							<span class="desc">
								{{detail.pinpaishangjia}}
							</span>
						</div>
																								<div class="detail-item">
							<span>饲料质量：</span>
							<span class="desc">
								{{detail.siliaozhiliang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>饲料配料：</span>
							<span class="desc">
								{{detail.siliaopeiliao}}
							</span>
						</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`siliaogoumai`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.siliaomingcheng;
																																																																						// 轮播图片
					vue.swiperList = vue.detail.siliaotupian ? vue.detail.siliaotupian.split(",") : [];
																																													var swiperItemHtml = '';
