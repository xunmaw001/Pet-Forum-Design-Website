        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">饲料购买展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="siliaomingcheng" id="siliaomingcheng" placeholder="饲料名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">使用宠物</label>
                <div class="layui-input-inline">
                  <input type="text" name="shiyongchongwu" id="shiyongchongwu" placeholder="使用宠物" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">饲料种类</label>
                <div class="layui-input-inline">
                  <input type="text" name="siliaozhonglei" id="siliaozhonglei" placeholder="饲料种类" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">品牌商家</label>
                <div class="layui-input-inline">
                  <input type="text" name="pinpaishangjia" id="pinpaishangjia" placeholder="品牌商家" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('siliaogoumai','新增')" @click="jump('../siliaogoumai/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../siliaogoumai/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../siliaogoumai/detail.jsp?id='+item.id)"><span>{{item.siliaomingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#siliaomingcheng').val()) {
          param['siliaomingcheng'] = jquery('#siliaomingcheng').val() ? '%' + jquery('#siliaomingcheng').val() + '%' : '';
        }  
        if (jquery('#shiyongchongwu').val()) {
          param['shiyongchongwu'] = jquery('#shiyongchongwu').val() ? '%' + jquery('#shiyongchongwu').val() + '%' : '';
        }  
        if (jquery('#siliaozhonglei').val()) {
          param['siliaozhonglei'] = jquery('#siliaozhonglei').val() ? '%' + jquery('#siliaozhonglei').val() + '%' : '';
        }  
        if (jquery('#pinpaishangjia').val()) {
          param['pinpaishangjia'] = jquery('#pinpaishangjia').val() ? '%' + jquery('#pinpaishangjia').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('siliaogoumai/list', 'get', param, function(res) {
