				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="touxiangUpload">
									<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">宠物上次疫苗日期</label>
							<div class="layui-input-block">
								<input type="text" name="chongwushangciyimiaoriqi" id="chongwushangciyimiaoriqi" placeholder="宠物上次疫苗日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="chongwuxingbie" id="chongwuxingbie">
									<option value="">请选择</option>
