        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">宠物服务机构展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="jigoumingcheng" id="jigoumingcheng" placeholder="机构名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">机构类别</label>
                <div class="layui-input-inline">
                  <input type="text" name="jigouleibie" id="jigouleibie" placeholder="机构类别" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('chongwufuwujigou','新增')" @click="jump('../chongwufuwujigou/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../chongwufuwujigou/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../chongwufuwujigou/detail.jsp?id='+item.id)"><span>{{item.jigoumingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jigoumingcheng').val()) {
          param['jigoumingcheng'] = jquery('#jigoumingcheng').val() ? '%' + jquery('#jigoumingcheng').val() + '%' : '';
        }  
        if (jquery('#jigouleibie').val()) {
          param['jigouleibie'] = jquery('#jigouleibie').val() ? '%' + jquery('#jigouleibie').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('chongwufuwujigou/list', 'get', param, function(res) {
