...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>宠物上次疫苗日期</label>
										<div id="chongwushangciyimiaoriqiDate" class="input-append date form_datetime">
											<input id="chongwushangciyimiaoriqi-input" name="chongwushangciyimiaoriqi" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										...
										<select id="chongwuxingbieSelect" name="chongwuxingbie" class="form-control">
												<option value=""></option>
												<option class="chongwuxingbieOption" value="雌">
													雌
												</option>
												<option class="chongwuxingbieOption" value="雄">
													雄
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#chongwushangciyimiaoriqiDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#chongwushangciyimiaoriqi-input").val(ruleForm.chongwushangciyimiaoriqi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chongwushangciyimiaoriqi != null && res.data.chongwushangciyimiaoriqi != ''){

					$("#chongwushangciyimiaoriqi-input").val(res.data.chongwushangciyimiaoriqi);
					$('#chongwushangciyimiaoriqiFileName').val(res.data.chongwushangciyimiaoriqi)
					}
