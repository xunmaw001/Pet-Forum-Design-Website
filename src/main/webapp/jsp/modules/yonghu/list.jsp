...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>头像</th>
											<th onclick="sort('chongwushangciyimiaoriqi')">宠物上次疫苗日期<i id="chongwushangciyimiaoriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chongwushangciyimiaoriqiCell  = document.createElement('td');

						  chongwushangciyimiaoriqiCell.innerHTML = item.chongwushangciyimiaoriqi;


			row.appendChild(chongwushangciyimiaoriqiCell);
