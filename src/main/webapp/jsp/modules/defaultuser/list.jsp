		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">注册用户管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>注册用户列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">注册用户列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('name')">姓名<i id="nameIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('sex')">性别<i id="sexIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('age')">年龄<i id="ageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('phone')">电话<i id="phoneIcon" class="fa fa-sort"></i></th>

											<th>照片</th>
											<th onclick="sort('email')">邮箱<i id="emailIcon" class="fa fa-sort"></i></th>
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("defaultuser/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
