		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑注册用户</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>注册用户管理</span></li>
								<li class="breadcrumb-item active"><span>编辑注册用户</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">注册用户信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="sexSelect" name="sex" class="form-control">
												<option value=""></option>
												<option class="sexOption" value="男">
													男
												</option>
												<option class="sexOption" value="女">
													女
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>年龄</label>
										<input id="age" name="age" class="form-control" placeholder="年龄">
									</div>
									<div class="form-group col-md-6">
										<label>电话</label>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("defaultuser/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("defaultuser/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.sex != null && res.data.sex != ''){

					var sexOptions = document.getElementsByClassName("sexOption");
						for(var sexCount = 0; sexCount < sexOptions.length;sexCount++){
							if(sexOptions[sexCount].getAttribute('value') == res.data.sex){
								sexOptions[sexCount].setAttribute('selected','selected');
							}
						}
					}
					if(res.data != null && res.data != '' && res.data.age != null && res.data.age != ''){
					...
					if(res.data != null && res.data != '' && res.data.email != null && res.data.email != ''){
